...
template <> constexpr inline auto Login::qt_create_metaobjectdata<qt_meta_tag_ZN5LoginE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'actualizarClimaEnUI'
        QtMocHelpers::SlotData<void(const WeatherInfo &)>(5, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 6, 7 },
        }}),
        // Slot 'mostrarMensaje'
        QtMocHelpers::SlotData<void(const QString &, bool)>(8, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QString, 9 }, { QMetaType::Bool, 10 },
        }}),
        // Slot 'setControlesHabilitados'
        QtMocHelpers::SlotData<void(bool)>(11, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::Bool, 12 },
        }}),
        // Slot 'validarCredenciales'
        QtMocHelpers::SlotData<void()>(13, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'actualizarBloqueo'
...
void Login::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->mostrar(); break;
        case 2: _t->ocultar(); break;
        case 3: _t->actualizarClimaEnUI((*reinterpret_cast<std::add_pointer_t<WeatherInfo>>(_a[1]))); break;
        case 4: _t->mostrarMensaje((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<bool>>(_a[2]))); break;
        case 5: _t->setControlesHabilitados((*reinterpret_cast<std::add_pointer_t<bool>>(_a[1]))); break;
        case 6: _t->validarCredenciales(); break;
        case 7: _t->actualizarBloqueo(); break;
        default: ;
        }
    }
