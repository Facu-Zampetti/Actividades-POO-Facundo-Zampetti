...
void SyncService::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->loadFinished((*reinterpret_cast<std::add_pointer_t<bool>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<QString>>(_a[2]))); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (SyncService::*)(bool , QString )>(_a, &SyncService::loadFinished, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (SyncService::*)(bool , QString )>(_a, &SyncService::saveFinished, 1))
            return;
    }
}
...
// SIGNAL 0
void SyncService::loadFinished(bool _t1, QString _t2)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1, _t2);
}

// SIGNAL 1
void SyncService::saveFinished(bool _t1, QString _t2)
{
